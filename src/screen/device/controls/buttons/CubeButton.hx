...
class CubeButton extends PickedObject {
	...
	override function init() : Void {
		...
		_normal = new Bitmap(Assets.getBitmapData('assets/bitmap/device/controls/cube.png'), null, true);
		addChild(_normal);
		
		_down = new Bitmap(Assets.getBitmapData('assets/bitmap/device/controls/cube_down.png'), null, true);
		_down.x = 3;
		addChild(_down);
